...
struct MeterIwmTX3 : public virtual MeterCommonImplementation {
    MeterIwmTX3(MeterInfo &mi);
...
shared_ptr<Meter> createIwmTX3(MeterInfo &mi)
{
    return shared_ptr<Meter>(new MeterIwmTX3(mi));
}

MeterIwmTX3::MeterIwmTX3(MeterInfo &mi) :
    MeterCommonImplementation(mi, "iwmtx3")
{
...
void MeterIwmTX3::processContent(Telegram *t)
{
    int offset;
    string key;
...
double MeterIwmTX3::totalWaterConsumption(Unit u)
{
    assertQuantity(u, Quantity::Volume);
    return convert(total_water_consumption_m3_, Unit::M3, u);
}

bool MeterIwmTX3::hasTotalWaterConsumption()
{
    return true;
}
